...
fs.readFile("../gameLogic/api/v1/resources/easy_levels_dataset.json", "utf8", (err, jsonString) => {
    if (err) {
...
fs.readFile("../gameLogic/api/v1/resources/easy_meta_levels.json", "utf8", (err, jsonString) => {
    if (err) {
        console.log("File read failed:", err);
        return;
    }
